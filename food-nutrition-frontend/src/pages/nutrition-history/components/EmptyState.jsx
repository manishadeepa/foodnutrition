...
.es-feature-card:hover {
  ...
  box-shadow: 0 8px 24px rgba(45,90,61,0.10);
  border-color: #bbf7d0;
}
.es-cta-btn {
      ...
      <div style={{ maxWidth: '440px', margin: '0 auto' }}>
        ...
        <div className="es-fade-1" style={{ display: 'flex', justifyContent: 'center', marginBottom: '2rem' }}>
          <div style={{ position: 'relative', width: 96, height: 96 }}>
            ...
            <div className="es-icon-wrap" style={{
              ...
              boxShadow: '0 8px 24px rgba(45,90,61,0.12)',
            }}>
              <Icon name="History" size={38} color="#2D5A3D" />
            </div>
          </div>
        </div>
        ...
        <div className="es-fade-2">
          <h2 style={{
            ...
            color: '#1a2e1a', margin: '0 0 0.6rem 0',
        ...
        <div className="es-fade-4" style={{
          ...
          <div style={{ flex: 1, height: '1px', background: '#edf0ed' }} />
          <span style={{ fontSize: '0.72rem', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 600 }}>
            What you'll get
          </span>
          <div style={{ flex: 1, height: '1px', background: '#edf0ed' }} />
        </div>
        ...
        <div className="es-fade-5" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.75rem' }}>
          {FEATURES.map((f, i) => (
            <div key={i} className="es-feature-card" style={{
              ...
              <p style={{ fontFamily: 'var(--font-heading, "Outfit", sans-serif)', fontSize: '0.8rem', fontWeight: 700, color: '#1a2e1a', margin: 0 }}>
                {f.title}
              </p>
